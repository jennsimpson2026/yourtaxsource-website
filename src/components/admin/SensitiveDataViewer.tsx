    ...
    <div className="bg-white rounded-2xl shadow-sm border border-red-100 overflow-hidden">
      <div className="p-6 border-b border-red-50 bg-red-50/30 flex justify-between items-center">
        ...
        <button
          ...
          disabled={isLoading}
          className="flex items-center gap-2 text-xs font-bold px-4 py-2 rounded-xl bg-white border border-red-200 text-red-600 hover:bg-red-50 transition-all shadow-sm disabled:opacity-50"
        >
          {isLoading ? (
        ...
        <div className="p-8 space-y-8 animate-in fade-in slide-in-from-top-2 duration-300">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 font-mono text-lg text-brand-navy">
          ...
          {data.dependents && data.dependents.length > 0 && (
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-brand-navy font-bold text-sm border-t border-gray-50 pt-6">
                <Users size={18} className="text-brand-orange" />
