    ...
    <div className="flex flex-col">
      <section className="bg-brand-navy py-16 md:py-32 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h1 className="text-4xl md:text-6xl font-heading font-bold mb-8">Frequently Asked <span className="text-brand-orange italic">Questions</span>.</h1>
      ...
      <section className="py-24 bg-brand-cloud">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white p-12 md:p-16 rounded-[3rem] shadow-xl border border-gray-100">
            <MessageCircle className="w-16 h-16 text-brand-orange mx-auto mb-8" />
            <h2 className="text-3xl font-heading font-bold text-brand-navy mb-6">Still have a question?</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              ...
              <Link
                href="tel:5551234567"
                className="inline-block bg-transparent border-2 border-brand-navy text-brand-navy px-10 py-5 rounded-xl font-bold text-xl hover:bg-brand-cloud transition-all flex items-center justify-center gap-2"
              >
                (555) 123-4567
              </Link>
            </div>
...
function FAQCategory({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="mb-12 last:mb-0">
      <h2 className="text-2xl font-heading font-bold text-brand-navy mb-8 border-b border-gray-100 pb-4 tracking-tight">
        {title}
      </h2>
...
function FAQItem({ question, answer, icon }: { question: string; answer: string; icon: React.ReactNode }) {
  return (
    <div className="bg-brand-cloud/30 p-8 rounded-3xl border border-transparent hover:border-brand-orange/20 hover:bg-white hover:shadow-xl transition-all group">
      <div className="flex gap-4 mb-4">
        <div className="mt-1 bg-white p-2 rounded-lg shadow-sm group-hover:bg-brand-orange/10 transition-colors">
          {icon}
        </div>
        <h3 className="text-xl font-heading font-bold text-brand-navy leading-tight">{question}</h3>
      </div>
      <div className="pl-12">
