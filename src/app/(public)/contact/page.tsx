    ...
    <div className="flex flex-col">
      <section className="bg-brand-navy py-16 md:py-32 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h1 className="text-4xl md:text-6xl font-heading font-bold mb-8">Let's Talk <span className="text-brand-orange italic">Taxes</span>.</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            <div className="space-y-12">
              <div>
                <h2 className="text-3xl font-heading font-bold text-brand-navy mb-6 border-l-4 border-brand-orange pl-6">Get In Touch</h2>
            ...
            <div className="bg-brand-cloud p-1 md:p-2 rounded-[2.5rem] shadow-2xl">
              <div className="bg-white p-8 md:p-12 rounded-[2rem] h-full shadow-inner">
                <div className="flex items-center gap-4 mb-10 bg-brand-cloud/50 p-4 rounded-2xl border border-gray-100">
                  ...
                  <div>
                    <h3 className="text-xl font-heading font-bold text-brand-navy">Send a Message</h3>
      ...
      <section className="py-24 bg-brand-navy text-white overflow-hidden relative">
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-brand-orange opacity-5 rounded-full -mr-48 -mb-48"></div>
              ...
              <div className="space-y-4 max-w-md">
                ...
                <div className="flex justify-between items-center py-4 border-b border-white/10">
                  <div className="flex flex-col">
                    ...
                    <span className="text-brand-orange text-sm font-bold uppercase tracking-wider">Tax Season Only</span>
                  </div>
...
function ContactInfoItem({ 
  ...
  return (
    <div className="flex gap-6 group">
      <div className="bg-brand-cloud w-16 h-16 rounded-2xl flex items-center justify-center flex-shrink-0 border border-gray-100 shadow-sm group-hover:bg-brand-orange/10 group-hover:border-brand-orange/20 transition-all">
        {icon}
      </div>
      <div>
        <h4 className="font-heading font-bold text-brand-navy text-xl mb-1">{title}</h4>
        <p className="text-brand-charcoal text-lg font-bold group-hover:text-brand-orange transition-colors">{value}</p>
